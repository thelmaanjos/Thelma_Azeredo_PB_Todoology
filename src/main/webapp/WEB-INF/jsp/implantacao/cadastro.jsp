						...
						<div class="row g-3">
							<div class="col-sm-6">
								<label class="form-label fw-bold">Nome da tarefa em
									implantação</label> <input type="text" class="form-control"
							...
							<div class="col-sm-6">
								<label for="text" class="mb-3 fw-bold">O programa está
									funcionando?</label>
							...
							<div class="col-sm-6">
								<label for="text" class="mb-3 fw-bold">Os funcionários
							...
							<div class="col-sm-6">
								<label class="form-label fw-bold">Quantidade de
									funcionários treinados</label> <input type="number"
									class="form-control" name="qtdFuncTreinados" value="15"
									required>
								<div class="invalid-feedback">Insira a quantidade</div>
							</div>
							<div class="col-sm-6">
								<label for="text" class="form-label fw-bold">Considerações
									finais </label>
