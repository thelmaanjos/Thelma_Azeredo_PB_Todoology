...
<div
	...
	<ul class="nav nav-pills flex-column">
		<li><a href="/projeto/lista" class="nav-link text-white"> <svg
					class="bi me-2" width="16" height="16">
							<use xlink:href="#grid" /></svg> Novo projeto
		</a></li>
		<li><a href="/atividade/lista" class="nav-link text-white"> <svg
					class="bi me-2" width="16" height="16">
	...
	<ul class="nav nav-pills flex-column">
		<li><a href="#" class="nav-link text-white"> <svg
					class="bi me-2" width="16" height="16">
							<use xlink:href="#people-circle" /></svg> Seu perfil
		</a></li>
		<li><a href="#" class="nav-link text-white"> <svg
					class="bi me-2" width="16" height="16">
							<use xlink:href="#people-circle" /></svg> Configurações
		</a></li>
	</ul>
	<hr>
	<div class="dropdown">
		<a href="#"
			...
			class="rounded-circle me-2"> ${user.email}
		</a>
